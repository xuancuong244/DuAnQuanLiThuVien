...
public class ScanQRJFrame extends javax.swing.JFrame implements Runnable, ThreadFactory {
    ...
    private void initComponents() {
        ...
        jPanel1.add(lblClose, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 0, 30, 30));
...
//               e.printStackTrace();
            ...
            if (result != null) {
                ...
                this.dispose();
                webcam.close();
                new DangNhapJDialog(new TrangChuJFrame(), true, userName, pass).setVisible(true);
            }
        } while (true);
    }
