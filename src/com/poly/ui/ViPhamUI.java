 ...
 * @author CuongNX
 */
public class ViPhamUI extends javax.swing.JPanel {

    /**
     * Creates new form ViPhamUI
     */
    ...
    private void initComponents() {
        ...
        tblDanhSach.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Violation ID", "Violation Error", "Readers ID "
            }
        ) {
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(466, 144, 520, 380));

        jPanel5.setBackground(new java.awt.Color(205, 240, 234));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel3.setText("Violation ID:");

        jLabel4.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel4.setText("Reader ID:");

        txtReaderID.setBackground(new java.awt.Color(205, 240, 234));
        txtReaderID.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        txtReaderID.setBorder(null);
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                ...
                .addGap(3, 3, 3)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(txtReaderID, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 140, -1, -1));
        ...
        jLabel1.setText("VIOLATION MANAGEMENT");
        ...
        jPanel1.add(btnNew, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 570, -1, 39));
    ...
    void clear() {
        this.setModel(new ViPham());
        this.setStatus(true);

    }

    private boolean isValidate(ViPham s) {
        if (s.getMaViPham().equals("")) {
    ...
    private void edit() {
        try {
            String maViPham = (String) tblDanhSach.getValueAt(this.index, 0);
            ViPham model = dao.selectById(maViPham);
            if (model != null) {
                this.setModel(model);
    ...
    void insert() {
        ...
        try {
            ...
            this.load();
            this.clear();
            XDialog.alert(this, "Add Violation successful!");
        } catch (Exception e) {
//            XDialog.alert(this, "Add Violation fail!");
e.printStackTrace();
        }
    }
    ...
    void update() {
        ...
        try {
            dao.update(model);
            this.load();
            XDialog.alert(this, "Update Violation successful!");
        } catch (Exception e) {
            XDialog.alert(this, "Update Violation fail!");
        }
    }

    void delete() {
        if (XDialog.confirm(this, "Are you sure to delete this Violation?")) {
            String matg = txtID.getText();
            try {
                dao.delete(matg);
                this.load();
                this.clear();
                XDialog.alert(this, "Delete Violation successful!");
            } catch (Exception e) {
                XDialog.alert(this, "Delete Violation fail!");
            }
        }
    }

    private ViPham getModel() {
        ViPham model = new ViPham();
        model.setMaViPham(txtID.getText());
        model.setTen(txtError.getText());
        model.setMaDG(txtReaderID.getText());
        return model;
    }

    private void setModel(ViPham model) {
        txtID.setText(model.getMaViPham());
        txtError.setText(model.getTen());
        txtReaderID.setText(model.getMaDG());
    }
